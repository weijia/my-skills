...
由于项目部署在子目录下（如 `online/my-app/latest/`、`online/my-app/release/`、`online/my-app/20250525/`），可以在页面底部添加版本切换链接，方便用户在不同版本间跳转。

### 实现逻辑

从 `window.location.pathname` 提取当前版本目录名（路径最后一段），然后生成相对路径链接：
